...
import { sendInviteEmail } from '../email/email'; // Custom function to send invite emails
...
const ACreateTeam = () => {
  ...
  const handleCreateTeam = async (e: React.FormEvent) => {
    ...
    try {
      const teamDocRef = doc(db, 'teams', uniqueCode);
      ...
      membersEmails.forEach((email) => sendInviteEmail(email, uniqueCode)); // Send invite emails
